...
const LoginComponent = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen"> {/* Flex container to manage layout */}
            <div className="w-full h-full flex items-center justify-center bg-green-200 relative flex-grow">
                <video src={video} autoPlay muted loop className="absolute top-0 left-0 w-full h-full object-cover z-0" />
